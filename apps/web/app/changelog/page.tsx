...
const entries = [
  {
    ...
    title: "CLI 0.4.4 — interactive UX and --no-init",
    items: [
      "Published @aipm-registry/cli@0.4.4 to npm with mint-branded interactive menus (arrow keys, highlight bar) for recoverable errors.",
